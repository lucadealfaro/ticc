...
external mdd_is_zeroone         : mdd -> int -> bool = "mlglu_is_tautology"
let mdd_is_zero mdd = mdd_is_zeroone mdd 0
let mdd_is_one  mdd = mdd_is_zeroone mdd 1 
...
external mdd_max  : mdd -> int -> mdd = "mlglu_max"
external mdd_min  : mdd -> int -> mdd = "mlglu_min"
external mdd_incr : mdd -> int -> mdd = "mlglu_incr"
external mdd_get_unique_value : mdd_manager -> mdd -> int -> int = "mlglu_get_unique_value"
