...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddSubsetHB.c,v 1.1 2005/04/21 05:58:01 luca Exp $";
#endif
...
static void ResizeNodeDataPages ARGS((void));
static void ResizeCountMintermPages ARGS((void));
static void ResizeCountNodePages ARGS((void));
  ...
  int  threshold /* threshold size for the subset */)
{
    ...
    if (st_lookup(visitedTable, (char *)f, (char **)&currNodeQual) == 0) {
	fprintf(dd->err,
