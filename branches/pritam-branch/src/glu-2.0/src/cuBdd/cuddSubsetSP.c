...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddSubsetSP.c,v 1.1 2005/04/21 05:58:01 luca Exp $";
#endif
...
static void ResizeNodeDistPages ARGS((void));
static void ResizeQueuePages ARGS((void));
