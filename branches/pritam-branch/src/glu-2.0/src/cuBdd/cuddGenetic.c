...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddGenetic.c,v 1.1 2005/04/21 05:58:00 luca Exp $";
#endif
...
static int find_best ARGS((void));
#ifdef DD_STATS
static double find_average_fitness ARGS((void));
#endif
