/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cudd.h,v 1.3 2006/01/28 05:31:32 vishwa Exp $]
...
EXTERN unsigned long Cudd_ReadMemoryInUse ARGS((DdManager *dd));
...
EXTERN unsigned long Cudd_ReadMaxMemory ARGS((DdManager *dd));
EXTERN void Cudd_SetMaxMemory ARGS((DdManager *dd, unsigned long maxMemory));
...
EXTERN DdNode * Cudd_bddAndLimit ARGS((DdManager *dd, DdNode *f, DdNode *g, unsigned int limit));
...
EXTERN DdTlcInfo * Cudd_FindTowLiteralClauses ARGS((DdManager * dd, DdNode * f));
EXTERN int Cudd_PrintTwoLiteralClauses ARGS((DdManager * dd, DdNode * f, char **names, FILE *fp));
EXTERN int Cudd_ReadIthClause ARGS((DdTlcInfo * tlc, int i, DdHalfWord *var1, DdHalfWord *var2, int *phase1, int *phase2));
EXTERN void Cudd_tlcInfoFree ARGS((DdTlcInfo * t));
...
EXTERN DdNode * Cudd_bddNPAnd ARGS((DdManager *dd, DdNode *f, DdNode *c));
...
EXTERN DdNode * Cudd_bddPickOneMintermRandom ARGS((DdManager *dd, DdNode *f, DdNode **vars, int n, int overAllVars));
/*ashwini add end */
...
EXTERN long Cudd_Random ARGS((void));
